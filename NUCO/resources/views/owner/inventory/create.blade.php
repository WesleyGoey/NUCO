        ...
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm border-0" style="border-radius:12px; overflow:hidden;">
                <div class="card-header" style="background:#A4823B;padding:18px;">
                    <h4 class="m-0 fw-bold text-center" style="color:#F5F0E5;">Add New Ingredient</h4>
                </div>
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <div class="mt-2 fw-semibold" style="color:#4b3028;">Create Stock Item</div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input id="name" name="name" type="text" class="form-control" required
                                       value="{{ old('name') }}" placeholder="e.g. Rice, Oil, Salt"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input id="unit" name="unit" type="text" class="form-control" required
                                       value="{{ old('unit') }}" placeholder="e.g. kg, ltr, pcs"
                                       style="border-radius:10px;padding:10px;">
                                @error('unit')
                                    <div class="text-danger mt-1 small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12 col-md-6">
                                <label for="current_stock" class="form-label fw-bold" style="color:#4b3028;">Current Stock</label>
                                <input id="current_stock" name="current_stock" type="number" step="0.01" class="form-control" required
