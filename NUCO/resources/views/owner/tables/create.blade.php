        ...
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm border-0" style="border-radius:12px; overflow:hidden;">
                <div class="card-header" style="background:#A4823B;padding:18px;">
                    <h4 class="m-0 fw-bold text-center" style="color:#F5F0E5;">Add New Table</h4>
                </div>
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <div class="mt-2 fw-semibold" style="color:#4b3028;">Create New Table</div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('owner.tables.store') }}">
                        ...
                        <div class="d-flex justify-content-center gap-3 mt-4">
                            ...
                            <button type="submit" class="btn" 
                                ...
                                <i class="bi bi-check-circle me-2"></i> Create Table
                            </button>
                        </div>
                    </form>
                </div>
