        ...
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm border-0" style="border-radius:12px; overflow:hidden;">
                <div class="card-header" style="background:#A4823B;padding:18px;">
                    <h4 class="m-0 fw-bold text-center" style="color:#F5F0E5;">Add New Discount</h4>
                </div>
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <div class="mt-2 fw-semibold" style="color:#4b3028;">Create Promo Period</div>
                    </div>

                    <form method="POST" action="{{ route('owner.discounts.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <select id="type" name="type" class="form-select" required
                                    ...
                                    <option value="amount" {{ old('type') == 'amount' ? 'selected' : '' }}>Amount (Rp)</option>
                                </select>
                                @error('type')
                                    <div class="text-danger mt-1 small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="period_description" name="period_description" rows="3"
                                       class="form-control"
                                       style="border-radius:10px;border:1px solid rgba(164,130,59,0.12);padding:0.6rem 0.9rem;">{{ old('period_description') }}</textarea>
